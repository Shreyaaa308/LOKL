export default function Landing({ onCreator, onBrand, onCreatorLogin, onBrandLogin, onDiscover, theme: t }) {
  return (
    <div style={{
      minHeight: '100vh',
      background: t.bg,
      ...
      <p style={{
        ...
        Where a local business finds nearby creators, and creators build real careers without needing 1M followers.
      </p>
      ...
      <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap', justifyContent: 'center', marginBottom: '14px' }}>
        <button onClick={onCreatorLogin} style={{
          background: t.purple,
          color: 'white',
          border: 'none',
          padding: '16px 32px',
        ...
        <button onClick={onBrandLogin} style={{
          background: t.card,
          color: t.purple,
